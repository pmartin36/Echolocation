...
Shader "Universal Render Pipeline/Screen Space Decal/Unlit"
{
    Properties
    {
        ...
        [Enum(UnityEngine.Rendering.CullMode)]_Cull("_Cull (default = Front) _____to improve GPU performance, Set to Back if camera never goes into cube volume, else set to Front", Float) = 1 //0 = Off, 1 = Front
